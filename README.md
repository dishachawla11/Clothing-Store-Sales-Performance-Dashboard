...
* **Order Status Analysis** — Analyzes delivered, cancelled, returned, and refunded orders.
...
* Maharashtra and Karnataka were among the strongest-performing states, indicating opportunities to focus marketing and expansion efforts in high-performing regions.
* Delivered orders accounted for the majority of orders, while cancelled, returned, and refunded orders represented smaller portions of the overall order volume.
